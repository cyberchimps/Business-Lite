...
<p><img src="<?php echo get_template_directory_uri() ;?>/images/chimp.png" alt="CyberChimps" /><strong>Welcome to <?php echo $themenamefull; ?>! Learn more now about upgrading to <a href="http://cyberchimps.com/businesspro/" target="_blank"><?php echo $themenamefull; ?> Pro</a> today.</p>
