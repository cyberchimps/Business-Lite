...
<p><img src="<?php echo get_template_directory_uri() ;?>/images/chimp.png" alt="CyberChimps" /><strong>iFeature has successfully been installed.</strong> Want more features? <a href="http://cyberchimps.com/ifeaturepro/" target="_blank">Learn more about upgrading to iFeature Pro.</a>
<span class="twitter">
