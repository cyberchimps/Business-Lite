<?php
/**
* CyberChimps Business lite Core Functions
*
...
function business_styles() {
	...
	if( $font == 'Actor' ||
		...
		wp_register_style( 'fonts', $protocol . '://fonts.googleapis.com/css?family=' . $font, array( 'business_style' ) );		
	}
...
add_filter( 'wp_title', 'business_title_tag_filter', 10, 3 )
