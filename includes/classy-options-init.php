...
")
	...
	->section("Header")
		...
		->close_outersection()
		->subsection("Slider")
			->upload($themeslug."_front_slide_one_image", "Slide One Image", array('default' => array('url' => TEMPLATE_URL . '/images/responseslider.jpg')))
			->text($themeslug."_front_slide_one_url", "Slide One Link", array('default' => 'http://cyberchimps.com'))
			->upload($themeslug."_front_slide_two_image", "Slide Two", array('default' => array('url' => TEMPLATE_URL . '/images/responseslider.jpg')))
			->text($themeslug."_front_slide_two_url", "Slide Two Link", array('default' => 'http://cyberchimps.com'))
			->upload($themeslug."_front_slide_three_image", "Slide Three", array('default' => array('url' => TEMPLATE_URL . '/images/responseslider.jpg')))
