...
")
	...
	->section("Header")
		...
		->subsection("Slider")
			...
			->text($themeslug."_front_slide_two_url", "Slide Two Link", array('default' => 'http://cyberchimps.com/businesspro/'))
			->upload($themeslug."_front_slide_three_image", "Slide Three", array('default' => array('url' => TEMPLATE_URL . '/images/slide_default_3.jpg')))
			->text($themeslug."_front_slide_three_url", "Slide Three Link", array('default' => 'http://cyberchimps.com'))
