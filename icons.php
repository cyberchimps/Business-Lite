...
*/
	...
	$gplus			= $options['bu_gplus'] ;
	$hidegplus	  = $options['bu_hide_gplus'];
...
<div class="icons">
	...
	<?php if ($hidegplus != '1' AND $gplus != '' ):?>
		<a href="<?php echo $gplus ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/social/gplus.png" alt="Google Plus" /></a>
	<?php endif;?>
	<?php if ($hidegplus != '1' AND $gplus == '' ):?>
		<a href="http://plus.google.com" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/social/gplus.png" alt="Twitter" /></a>
	<?php endif;?>
